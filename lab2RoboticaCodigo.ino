...
//PID
double originalSetpoint = 175.6; //Busqueda de Referencia angulo 0
...
void loop()
{
    if(BT.available()>0){     // se comprueba que el dispositivo bluetooth este conectado correctamente 
        ...
        //Estado 65 KP recibe numero con nuevo valor KP
        //Estado 66 Ki recibe numero con nuevo valor Ki
        //Estado 67 Kd recibe numero con nuevo valor Kd
        //Estado 68 boton adelante
